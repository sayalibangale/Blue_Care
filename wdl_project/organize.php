                ...
                <div class="col text-center">
                  ...
                  <div class="row mt-5 page-intro">
                    <div class="col-md-8 offset-md-2">
                      <p style="color:white;">If you want to organise a beach clean you can upload the details here and then invite people to join you. Before you register your beach clean make sure you have <a style="color:orange;" href="guidelines.html">read through our guidelines</a>.</p>
                    </div>
                  </div>
                      </div>
              </div>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <div class="footer-content logo-footer">
                                <div class="footer-head">
                                    ...
                                    <p>
                                        Are you looking for professional advice for your new business. Are you looking for professional advice for your new busine
                                    </p>
