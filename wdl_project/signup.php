                        ...
                        <div class="mobile-menu">
                                ...
                                <nav id="dropdown">
                                    <ul>
                                        ...
                                        <li><a href="about.html">About us</a></li>
                                        <li><a href="find.html">Beach Cleanup</a></li>
                            ...
                            <div class="login-form signup-form">
                                <h4 class="login-title ">REGISTER</h4>
                                    ...
                                    <form method="POST" class="log-form">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input type="email" name="email" class="form-control" placeholder="Your Email" requireds>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    if(isset($_POST['register'])) {
										...
										$query = "insert into login values ('$name','$email','$pass')";
										$select_query = "select * from login where uname='$name' && email='$email'";
